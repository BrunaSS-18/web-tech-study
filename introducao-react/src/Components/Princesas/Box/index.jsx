...
function index() {
  ...
  const boxPrincesas = [
    ...
    {
        img: "https://upload.wikimedia.org/wikipedia/pt/c/ce/Rapunzel_by_Disney.png?utm_source=pt.wikipedia.org&utm_campaign=index&utm_content=original",
        title:"Rapunzel",
    ...
    {
        img: "https://upload.wikimedia.org/wikipedia/pt/e/ef/Belle_by_Disney.png?utm_source=pt.wikipedia.org&utm_campaign=index&utm_content=original",
        title:"Bela",
    ...
    {
        img: "https://wallpapers.com/images/hd/moana-and-pets-fyxjriwg36ad6cmt.jpg",
        title:"Moana",
  ...
  return (
    <div className='box-container'>
        {boxPrincesas.map((box, index) => {
            console.log(index)
            return (
                <div className='box' key={index} style={{ backgroundColor: box.bgColor }}>
                    <img src={box.img}/>
                    <h2>{box.title}</h2>
                    <p>{box.textBox}</p>
